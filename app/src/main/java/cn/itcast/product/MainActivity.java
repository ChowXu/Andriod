...
public class MainActivity extends Activity {
	...
	private void initView() {
		...
		descET = (EditText)findViewById(R.id.nameDesc);
		picET = (EditText) findViewById(R.id.namePic);
		// 添加监听器, 监听条目点击事件
	...
	private class MyAdapter extends BaseAdapter {
		...
		TextView balanceTV = (TextView) item.findViewById(R.id.balanceTV);
			TextView descTV = (TextView) item.findViewById(R.id.descTV);
			TextView picTV = (TextView) item.findViewById(R.id.picTV);
          // 根据当前位置获取Account对象
		 ...
		 balanceTV.setText(a.getBalance() + "");
			descTV.setText(a.getDesc() );
			picTV.setText(a.getPic() );
